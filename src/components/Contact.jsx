...
import fiverr from "../asset/photos/fiverr2.png"
    ...
    return <div id="contact" className='Contact'>
        <div className='Contact_info'>
            ...
            <table className='Contact_table'>
                ...
                <tr>
                    <td className='Contact_icon'>
                        <a href="https://www.fiverr.com/lucine_ugc" target="_blank" rel="noreferrer"><img src={fiverr} alt="instagram" className='Contact_icon_item' /></a>
                    </td>
                    <td className='Contact_text'>
                        <a href="https://www.fiverr.com/lucine_ugc" target="_blank" rel="noreferrer" className='Contact_text_item'><p>www.fiverr.com/lucine_ugc</p></a>
                    </td>
                </tr>
            </table>
        </div>
